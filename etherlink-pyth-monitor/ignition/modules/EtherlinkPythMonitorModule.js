...
module.exports = buildModule("EtherlinkPythMonitorModule", (m) => {

  const _admin = m.getParameter("admin", "0x146F2D294aAE7996Bd95bae526472f751D32258c");
  const _pyth = m.getParameter("pyth", "0x2880aB155794e7179c9eE2e38200202908C17B43" ); // testnet
  ...
  const _network = m.getParameter("network", 1);
